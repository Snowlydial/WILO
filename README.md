...
Working late often means stopping mid-thought and forgetting where you left off the next day. WILO isn't a task manager — it's a daily record. One entry per day, written in Markdown, with an optional reminder that keeps nagging until you either finish or reschedule.
